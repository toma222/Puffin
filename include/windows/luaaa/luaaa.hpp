...
namespace LUAAA_NS
{
    ...
    template <typename T>
    struct LuaStack<T &> : public LuaStack<T>
    {
    };
    template <typename T>
    struct LuaStack<const T &> : public LuaStack<T>
    ...
    template <typename T>
    struct LuaStack<volatile T &> : public LuaStack<T>
    {
    ...
    template <typename T>
    struct LuaStack<const volatile T &> : public LuaStack<T>
    {
...
#undef _NOTHING
    ...
    {
        typedef std::function<TRET(ARGS...)> FTYPE;
        (void)(func);
        struct HelperClass
        {
            static int Invoke(lua_State *state)
    ...
    template <typename TCLASS>
    char *LuaClass<TCLASS>::klassName = nullptr;
